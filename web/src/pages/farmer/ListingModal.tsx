    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16, background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(4px)' }}>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
          <div>
            <p style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: '#1A5C38', marginBottom: 4 }}>Listing</p>
            <h2 style={{ fontSize: '1.2rem', fontWeight: 800, color: '#111827' }}>{listing ? 'Edit Listing' : 'Add New Listing'}</h2>
          </div>
          <button
            onClick={onClose}
            ...
            <div style={{ background: '#F0FAF4', border: '1px solid #D6EFE1', borderRadius: 12, padding: '14px 16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                ...
                <span style={{
                  ...
                  background: cropMoa.trend_pct >= 0 ? 'rgba(26,92,56,0.1)' : 'rgba(220,38,38,0.08)',
                  color: cropMoa.trend_pct >= 0 ? '#1A5C38' : '#DC2626',
                }}>
              ...
              {topRegions.length > 0 && (
                <div>
                  <p style={{ fontSize: 11, color: '#6B7280', marginBottom: 6, fontWeight: 600 }}>Highest demand regions:</p>
